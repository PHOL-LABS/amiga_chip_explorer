...
export const metadata: Metadata = {
  ...
  description:
    'Interactive Amiga chip schematic viewer with clickable pins and signal reference GIFs. View pinouts for CIA, Paula, Alice, Lisa, Agnus and more.',
};
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4">
        ...
        />
        <p className="font-mono text-xs tracking-widest" style={{ color: 'var(--text-dim)' }}>
          LOADING SCHEMATIC...
        </p>
      </div>
    </div>
